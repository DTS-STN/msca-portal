...
export default function BenefitTasks({
  locale,
  taskList,
  dataCy,
          ...
          return (
            ...
            >
              <AppLink
                ...
                className="flex items-center rounded-sm py-1 text-sky-950 underline hover:text-blue-700 focus:outline-1 focus:outline-sky-700"
              >
                <span className="flex flex-wrap static text-xl font-normal">
                  {task.title}
                  <span>
                    {newTabTaskExceptions.includes(task.link) ? (
                      <FontAwesomeIcon
