import { createMemorySessionStorage, createSession, createSessionStorage, Session, SessionData } from 'react-router';
...
function createMemoryStore() {
  ...
  const { getSession, commitSession, destroySession } = createMemorySessionStorage<SessionData, SessionData >({
    cookie: cookie,
  });
