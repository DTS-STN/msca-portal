      ...
      <div className="max-w-3xl">
        ...
        <ul className="list-disc" data-cy="contact-task-list">
          <li className="mb-6 ml-5">
            <InlineLink to={t('contactUs:cdcp.href')}>{t('contactUs:cdcp')}</InlineLink>
          </li>
          <li className="mb-6 ml-5">
            <InlineLink to={t('contactUs:ei.href')}>{t('contactUs:ei')}</InlineLink>
          </li>
          <li className="mb-6 ml-5">
            <InlineLink to={t('contactUs:cpp.href')}>{t('contactUs:cpp')}</InlineLink>
          </li>
          <li className="mb-6 ml-5">
          ...
          <li className="mb-6 ml-5">
            <InlineLink to={t('contactUs:cdb.href')}>{t('contactUs:cdb')}</InlineLink>
          </li>
          <li className="mb-6 ml-5">
            <InlineLink to={t('contactUs:sin.href')}>{t('contactUs:sin')}</InlineLink>
          </li>
        </ul>
      </div>
    </>
