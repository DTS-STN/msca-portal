...
export const handle = {
  ...
  i18nNamespace: ['app', 'gcweb', 'inbox', 'inboxNowAvailable', 'inboxNotificationPreferencesSuccess', 'inboxNotificationPreferences', 'profileAndPreferences', 'contactUs', 'contactUsEi'],
