...
export default function ProfileAndPreferences({ loaderData, params }: Route.ComponentProps) {
  ...
  return (
    <>
      ...
      <ProfileList
        sectionName={t('profileAndPreferences:email-address-card')}
        profileCard={emailAddressCard}
      />
      <ProfileList
      ...
      />
      <ProfileList
        sectionName={t('profileAndPreferences:security-settings-card')}
        profileCard={securityCard}
      />

      <h2 className="font-lato text-gray-750 py-2 text-4xl font-semibold md:mt-2 md:py-4">{t('profileAndPreferences:personal-information-title')}</h2>
       <ProfileList
